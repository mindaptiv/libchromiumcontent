...
BINARIES = {
  ...
  'win32': [
    ...
    os.path.join('obj','media', 'cast', 'cast_common.lib'),
    os.path.join('obj', 'media', 'cast', 'cast_net.lib'),
    os.path.join('obj', 'chrome', 'common', 'extensions', 'api', 'chrome_api.lib'),
    # Isn't being built: os.path.join('chrome_zlib.lib'),
    os.path.join('obj', 'third_party', 'cld_2', 'cld2_static.lib'),
    os.path.join('obj', 'chrome', 'common.lib'),
    os.path.join('obj', 'chrome', 'common_constants.lib'),
    os.path.join('obj', 'chrome', 'common_net.lib'),
    ...
    os.path.join('obj', 'third_party', 'mojo', 'mojo_cpp_bindings.lib'),
    os.path.join('obj', 'mojo', 'mojo_environment_chromium.lib'),
    os.path.join('obj', 'third_party', 'mojo', 'mojo_js_bindings.lib'),
    os.path.join('obj', 'components', 'pref_registry.lib'),
    os.path.join('obj', 'third_party', 're2', 're2.lib'),
    os.path.join('obj', 'chrome', 'safe_browsing_proto.lib'),
